...
<body>
  ...
  <div class="container">
      ...
      <?php
        ...
        use App\Models\User;
         if(isset($_POST['sign-submit'])){
          ...
          $pass = md5($pass);
          $checkAccount = User::where('tenDangNhap', $username)->where('matKhau', $pass)->get();
    ...
    <div class="form-group ml-3 mr-3">
      ...
      <input type="text" class="form-control" id="username" name="username" placeholder="Email hoặc số diện thoại" name="username" required>
    ...
    <div class="form-footer pt-2 pb-4">
      <a href="dangky.php" class="form_back btn btn-outline-dark">ĐĂNG KÝ</a>
