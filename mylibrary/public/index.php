...
<?php
    ...
    $sql = Product::orderBy('id_product', 'desc')->get();
...
<body>
  ...
  <main>
    <div class="new-title mt-4">
      <h1 class="text-center text-danger font-weight-bold" id="new-book">Sách mới</h1>
      <hr>
    </div>
    <div class="container mt-3">
                  ...
                  if($count < 8) {
                    foreach($sql as $element){ ?>
                      <div class="col overflow-hidden mb-2">
                        ...
                        <div class="img-name">                
                          <a href="#" alt="shopping-cart" class="bg-light text-dark addCart d-none"><i class="fa-solid fa-cart-shopping"></i><span>Thêm vào giỏ</span></a><br>
                          <a href="chitiet.php?id=<?php echo $sql[$i]->id_product;?>" alt="detail" class="bg-light text-dark"><i class="fa-solid fa-maximize ml-1"></i><span class="bg-light text-dark">Chi tiết</span></a>   
                        </div>
                    ...
                    <?php } else { for($i=0; $i<8; $i++){?>
                      <div class="col overflow-hidden mb-2">
                        <div class="img-zoom">
                          <img  class="d-block w-100 img-fluid"  alt="..." src="../../image/SachKhoaHoc/<?php echo $sql[$i]->image;?>">
                          <?php echo '<p style="color: DarkRed; background-color: white;">' . $sql[$i]->theLoai . '</p>';?>
                        </div>          
                        <div class="img-name">               
                          <a href="#" alt="shopping-cart" class="bg-light text-dark addCart d-none"><i class="fa-solid fa-cart-shopping"></i><span>Thêm vào giỏ</span></a><br>
                          <a href="chitiet.php?id=<?php echo $sql[$i]->id_product;?>" alt="detail" class="bg-light text-dark"> <i class="fa-solid fa-maximize ml-1"></i><span class="bg-light text-dark">Chi tiết</span></a>   
                        </div>
                        <span>Giá sách: <?php echo '<span style="color:red;"><b>' . number_format($sql[$i]->gia,'0','',',') . 'đ'. '</b></span>';?></span>                       
                      </div>
                  <?php } ?>
                  <?php } ?> 
              </div>
      ...
      <!-- Section 2-->
      <div class="new-title mt-4">
        <h1 class="text-center text-danger font-weight-bold" id="hot-book">Sách bán chạy</h1>
          ...
          <div class="container-fluid">
            <div class="col-md-12 mt-2">
              <div class="row row-cols-2 row-cols-md-4 mb-4">
                <?php
                  $sql_new = Product::all();
                  for($i=0; $i<16; $i++){ if ( $i % 2 == 0) {?>
                      <div class="col overflow-hidden mb-2 cart">
                        <div class="img-zoom">
                          <img  class="d-block w-100 img-fluid "  alt="..." src="../../image/SachKhoaHoc/<?php echo $sql_new[$i]->image;?>">
                          <?php echo '<p style="color: DarkRed; background-color: white;">' . $sql_new[$i]->theLoai . '</p>';?>
                        </div>          
                        <div class="img-name">               
                          <a href="#" alt="shopping-cart" class="bg-light text-dark d-none"><i class="fa-solid fa-cart-shopping"></i><span>Thêm vào giỏ</span></a><br>
                          <a href="chitiet.php?id=<?php echo $sql[$i]->id_product;?>" alt="detail" class="bg-light text-dark addCart"> <i class="fa-solid fa-maximize ml-1"></i><span class="bg-light text-dark">Chi tiết</span></a>   
                        </div>
                        <span>Giá sách <?php echo '<span style="color:red;"><b>' . number_format($sql_new[$i]->gia,'0','',',') . 'đ'. '</b></span>';?></span>
    ...
    <div class="home-block mt-4">
      <div class="container">
        <div class="row row-cols-2 row-cols-md-4" style="background-color:white; border-radius: 5px;">
          <div class="col">
            <a href="#"><img class="img-fluid" src="../../image/Capture1.JPG"></a>
          </div>
          <div class="col">
            <a href="#"><img class="img-fluid" src="../../image/Capture2.JPG"></a>
          </div>
          <div class="col">
            <a href="#"><img class="img-fluid" src="../../image/Capture3.JPG"></a>
          </div>
          <div class="col">
            <a href="#"><img class="img-fluid" src="../../image/Capture4.JPG"></a>
          </div>          
        </div>
      </div>
    </div>
