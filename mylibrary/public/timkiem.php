...
<body>
  ...
  <main>
    ...
    if(isset($_POST['timkiem'])){
      ...
      $sql = Product::where('tenSach', 'LIKE', '%'. $tukhoa .'%')->orwhere('tacGia', 'LIKE', '%'. $tukhoa .'%')->get();
     // echo $sql;
    ?>
                  ...
                  foreach($sql as $element) {?>
                      <div class="col overflow-hidden mb-2 cart">
                        ...
                        <div class="img-name">               
                          ...
                          <a href="chitiet.php?id=<?php echo $element->id_product;?>" alt="detail" class="bg-light text-dark addCart"> <i class="fa-solid fa-maximize ml-1"></i><span class="bg-light text-dark">Chi tiết</span></a>   
                        </div>
